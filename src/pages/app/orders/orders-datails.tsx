...
export function OrdersDetails() {
  return (
    <DialogContent>
      <DialogHeader>
        <DialogTitle>Pedido: uhsiahshs928hqsh</DialogTitle>
        ...
        <Table>
          <TableBody>
            <TableRow>
              ...
              <TableCell className="flex justify-end">
                <div className="flex items-center gap-2">
                  <span className="h-2 rounded-full bg-slate-400"></span>
            ...
            <TableRow>
              ...
              <TableCell className="flex justify-end">(21) 0920129</TableCell>
            </TableRow>
            <TableRow>
            ...
            <TableRow>
              ...
              <TableCell className="flex justify-end">há 2 minutos</TableCell>
            </TableRow>
          </TableBody>
        </Table>
